...
\label{sec:org5ca3f42}
\subsection{Objectives of the labworks}
\label{sec:org3719023}
...
the sessions  the items listed in  tables \ref{tab:orga2aa0ed}, \ref{tab:org6df4622}, \ref{tab:org2896621},  \ref{tab:org1858224} and \ref{tab:orgfc762d3}.
Each of them  is organized as a  set of tasks that  should be mastered
progressively.

\begin{table}[htbp]
\caption{\label{tab:orga2aa0ed}
...
\midrule
\textit{[2018-02-27 Tue 10:10]--[2018-02-27 Tue 12:10]} & CTD & 02:00:00 & Visualization of remote sensing data\\
\textit{[2018-02-27 Tue 13:30]--[2018-02-27 Tue 17:30]} & CTD & 04:00:00 & Spectral indices + Segmentation\\
\textit{[2018-02-28 Wed 13:30]--[2018-02-28 Wed 17:30]} & CTD & 04:00:00 & Detection of floods +  Classification 1/2\\
\textit{[2018-03-02 Fri 08:00]--[2018-03-02 Fri 10:00]} & Projet & 00:00:00 & \textbf{Non présentiel} -> Training/validation sets\\
\textit{[2018-03-02 Fri 10:00]--[2018-03-02 Fri 12:00]} & CTD & 02:00:00 & Classification  2/2 + SITS 1/2\\
\textit{[2018-03-02 Fri 13:30]--[2018-03-02 Fri 17:30]} &  & 04:00:00 & SITS 2/2\\
\textit{[2018-03-06 Tue 13:30]--[2018-03-06 Tue 17:30]} &  & 04:00:00 & Dynamic Habitat Index\\
\textit{[2018-03-08 Thu 08:00]--[2018-03-08 Thu 10:00]} &  & 02:00:00 & Exam Group 1\\
\textit{[2018-03-08 Thu 10:10]--[2018-03-08 Thu 12:10]} & Exam & 02:00:00 & Exam Group 2\\
\midrule
Total &  & 30:00:00 & \\
\bottomrule
\end{tabular}
...
session.
\section{Data sets}
\label{sec:org3821486}
\subsection{Pleiades images}
\label{sec:org1e6dc66}
...
respectively. A true color composition is given in Figure \ref{fig:org63afd56}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./figures/quicklook_fabas_12_10_2013.jpg}
\caption{\label{fig:org63afd56}
...
GIS software. Table \ref{tab:org5f13505} gives the band order of the data.

\begin{table}[htbp]
\caption{\label{tab:org5f13505}
...
date and the Figure~\ref{fig:org07ae3b5} shows a false colors composition for
the  date \textit{[2012-05-03 Thu]}. Table~\ref{tab:orgf478d55}  gives the
band order of the data.

\begin{table}[htbp]
\caption{\label{tab:orgf478d55}
...
\ref{tab:org4c8652a}. To start easy, we just open  one band at a time: right click
...
\label{sec:org84069fe}
\subsection{Radiometric analysis}
\label{sec:org9abd2d1}
\begin{work}
...
having  value \texttt{1}  are from  the same  material.  Figure  \ref{fig:org77e0d70}
...
dealing with floods.  In Figure  \ref{orgda865db} is shown two quickbird images,
...
\caption{\label{fig:org04e7991}
Google view of the impacted area. The red square represents the area of Figure \ref{orgda865db}.}
\end{figure}

\section{Classification of remote sensing images}
\label{sec:orgda5b71e}
\subsection{Introduction}
\label{sec:orgca643b3}
...
\ref{fig:org4e99607}.   Five  classes  are  considered,  they  are  given  in  Table
\ref{tab:org585acea}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{./figures/label_fabas.jpg}
\caption{\label{fig:org4e99607}
Ground truth for the \emph{Fabas} image.}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org585acea}
...
introduction to command line tools is given in Appendix \ref{sec:orgef7892b}.
...
Additional usefull references are  given section \ref{sec:org12e1e5a}, take the
time to read them.
...
their standard deviation. \emph{You can check the figure \ref{org997364f} to do it automatically}.
\end{enumerate}
...
were extracted from the \href{https://www.data.gouv.fr/fr/datasets/registre-parcellaire-graphique-2012-contours-des-ilots-culturaux-et-leur-groupe-de-cultures-majorita/}{RPG} for  the same year. Table \ref{tab:orgd689945} provides
the different classes available of  these area. Details about the data
are given \ref{sec:org1bac95f}.

\begin{table}[htbp]
\caption{\label{tab:orgd689945}
...
\label{sec:org30edc3d}
\subsection{Introduction}
\label{sec:org9f32ef1}
...
lab, the NDVI will be used. The data is described in \ref{sec:org1bac95f}.
...
\end{work}
\section{Appendix}
\label{sec:orgd6fa157}
\subsection{Short introduction to shell}
\label{sec:orgef7892b}
...
\begin{verbatim}
Bonjour j'ai eu 36 ans
\end{verbatim}

\subsubsection{Loop}
\label{sec:orgc4f2a16}
