...
\label{sec:org4706992}
\subsection{Objectives of the labworks}
\label{sec:org2cddb98}
...
the sessions  the items listed in  tables \ref{tab:orgc509b56}, \ref{tab:org0e60281}, \ref{tab:org3b88153},  \ref{tab:orgfd41073} and \ref{tab:org89a1f42}.
Each of them  is organized as a  set of tasks that  should be mastered
progressively.

\begin{table}[htbp]
\caption{\label{tab:orgc509b56}
...
session.
\section{Data sets}
\label{sec:orgd23929e}
\subsection{Pleiades images}
\label{sec:orgb6c4247}
...
respectively. A true color composition is given in Figure \ref{fig:orgee7dcf2}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./figures/quicklook_fabas_12_10_2013.jpg}
\caption{\label{fig:orgee7dcf2}
...
GIS software. Table \ref{tab:org21ca527} gives the band order of the data.

\begin{table}[htbp]
\caption{\label{tab:org21ca527}
...
date and the Figure~\ref{fig:orgd00d60e} shows a false colors composition for
...
\ref{tab:org3243322}. To start easy, we just open  one band at a time: right click
...
\label{sec:org654fb1c}
\subsection{Radiometric analysis}
\label{sec:orgb955516}
\begin{work}
...
having  value \texttt{1}  are from  the same  material.  Figure  \ref{fig:org68b58cb}
...
dealing with floods.  In Figure  \ref{orgc392049} is shown two quickbird images,
...
\caption{\label{fig:orgdd144fd}
Google view of the impacted area. The red square represents the area of Figure \ref{orgc392049}.}
\end{figure}

\section{Classification of remote sensing images}
\label{sec:orga9690f0}
\subsection{Introduction}
\label{sec:orgec2d6e3}
...
\ref{fig:org728cb75}.   Five  classes  are  considered,  they  are  given  in  Table
\ref{tab:org908d8ae}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{./figures/label_fabas.jpg}
\caption{\label{fig:org728cb75}
Ground truth for the \emph{Fabas} image.}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org908d8ae}
...
Additional usefull references are  given section \ref{sec:org3bfa37b}, take the
time to read them.
...
their standard deviation. \emph{You can check the figure \ref{org08b16fc} to do it automatically}.
\end{enumerate}
...
were extracted from the \href{https://www.data.gouv.fr/fr/datasets/registre-parcellaire-graphique-2012-contours-des-ilots-culturaux-et-leur-groupe-de-cultures-majorita/}{RPG} for  the same year. Table \ref{tab:orgdcd5cad} provides
the different classes available of  these area. Details about the data
are given \ref{sec:org684b106}.

\begin{table}[htbp]
\caption{\label{tab:orgdcd5cad}
...
The code given  figure \ref{orgee9df78} might help you.  It extracts all
...
\label{sec:org72ea3d2}
\subsection{Introduction}
\label{sec:org440dfc1}
...
lab, the NDVI will be used. The data is described in \ref{sec:org684b106}.
...
\end{work}
\section{Appendix}
\label{sec:org563bed0}
\subsection{Short introduction to shell}
\label{sec:orgb091ab1}
