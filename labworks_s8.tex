...
\ref{tab:org1f0853f}. To start easy, we just open  one band at a time: right click
...
dealing with floods.  In Figure  \ref{orgedfafbf} is shown two quickbird images,
...
\ref{fig:org0b70287}.   Five  classes  are  considered,  they  are  given  in  Table
\ref{tab:orgab0592e}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{./figures/label_fabas.jpg}
\caption{\label{fig:org0b70287}
Ground truth for the \emph{Fabas} image.}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orgab0592e}
...
their standard deviation. \emph{You can check the figure \ref{org4aa08dd} to do it automatically}.
\end{enumerate}
...
\label{sec:orgd838a25}
\subsection{Template filters}
\label{sec:org2c46434}
\subsubsection{Introduction}
\label{sec:org0be84dd}
...
image filters). In figure \ref{orgd8fd636} is provided a skeleton of such function, using
