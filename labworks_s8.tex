...
\end{enumerate}
\end{work}
\subsection{{\bfseries\sffamily INPROGRESS} Characterization of ecozones}
...
uses \texttt{Unix} (shell) standard Unix path expansion rules. However, results
are  returned  in arbitrary  order  and  therefore sometimes  ordering
operation is necessary. It returns a  list of pathnames, or a iterator
which can be  useful for large processing. Below some  examples to see
how it works. First, check what is in my \emph{figures} directory:
