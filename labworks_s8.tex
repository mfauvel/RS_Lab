...
\label{sec:org8bb507b}
\subsection{Objectives of the labworks}
\label{sec:orgf0d6b9e}
...
the sessions  the items listed in  tables \ref{tab:org98a2408}, \ref{tab:orga2be2ad}, \ref{tab:org6341001},  \ref{tab:org8505dbc} and \ref{tab:org17116b9}.
Each of them  is organized as a  set of tasks that  should be mastered
progressively.

\begin{table}[htbp]
\caption{\label{tab:org98a2408}
...
session.
\section{Data sets}
\label{sec:org7c9f3b7}
\subsection{Pleiades images}
\label{sec:orge920252}
...
respectively. A true color composition is given in Figure \ref{fig:org0257e96}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.5\textwidth]{./figures/quicklook_fabas_12_10_2013.jpg}
\caption{\label{fig:org0257e96}
...
GIS software. Table \ref{tab:org1fe8bba} gives the band order of the data.

\begin{table}[htbp]
\caption{\label{tab:org1fe8bba}
...
date and the Figure~\ref{fig:org093f927} shows a false colors composition for
the  date \textit{[2012-05-03 Thu]}. Table~\ref{tab:orgb983ded}  gives the
band order of the data.

\begin{table}[htbp]
\caption{\label{tab:orgb983ded}
...
\ref{tab:orgcd14d07}. To start easy, we just open  one band at a time: right click
...
\label{sec:orgc6b177e}
\subsection{Radiometric analysis}
\label{sec:orgb188c6f}
\begin{work}
...
having  value \texttt{1}  are from  the same  material.  Figure  \ref{fig:orgff4c2ef}
...
dealing with floods.  In Figure  \ref{org9c2ee65} is shown two quickbird images,
...
\caption{\label{fig:org962db7e}
Google view of the impacted area. The red square represents the area of Figure \ref{org9c2ee65}.}
\end{figure}

\section{Classification of remote sensing images}
\label{sec:orgea4ab60}
\subsection{Introduction}
\label{sec:orgabb9cb1}
...
\ref{fig:org912be30}.   Five  classes  are  considered,  they  are  given  in  Table
\ref{tab:orga512881}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{./figures/label_fabas.jpg}
\caption{\label{fig:org912be30}
Ground truth for the \emph{Fabas} image.}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orga512881}
...
introduction to command line tools is given in Appendix \ref{sec:org8cbd91e}.
...
Additional usefull references are  given section \ref{sec:orga5c6a69}, take the
time to read them.
...
their standard deviation. \emph{You can check the figure \ref{org3054ece} to do it automatically}.
\end{enumerate}
...
lab, the NDVI will be used. The data is described in \ref{sec:orgcb2ebba}.
...
\label{sec:orgb7c4108}
\subsection{Template filters}
\label{sec:org6ef2b10}
\subsubsection{Introduction}
\label{sec:org513d059}
...
image filters). In figure \ref{org5cc8439} is provided a skeleton of such function, using
...
It concerns the filtering of  historical maps, see \ref{sec:org5381341} to see
...
\ref{fig:org801f3b9}. You should write a script that takes as arguments:
\begin{itemize}
...
\begin{enumerate}
\item Add command line arguments parser (see \ref{sec:org8859e27})
...
\end{work}
\section{Appendix}
\label{sec:orgfc39a61}
\subsection{Short introduction to shell}
\label{sec:org8cbd91e}
