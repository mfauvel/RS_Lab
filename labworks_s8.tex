...
dealing with floods.  In Figure  \ref{org683e824} is shown two quickbird images,
...
\ref{fig:orgde62a89}.   Five  classes  are  considered,  they  are  given  in  Table
\ref{tab:orgc7b5137}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{./figures/label_fabas.jpg}
\caption{\label{fig:orgde62a89}
Ground truth for the \emph{Fabas} image.}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:orgc7b5137}
...
\end{work}
\section{Appendix}
\label{sec:org88f5861}
\subsection{Short introduction to shell}
\label{sec:orgc71649c}
