...
\ref{tab:org8b0bf41}. To start easy, we just open  one band at a time: right click
...
dealing with floods.  In Figure  \ref{orgf24c135} is shown two quickbird images,
...
\ref{fig:orgbbb9a33}.   Five  classes  are  considered,  they  are  given  in  Table
\ref{tab:org1b887c4}.

\begin{figure}[htbp]
\centering
\includegraphics[width=0.75\textwidth]{./figures/label_fabas.jpg}
\caption{\label{fig:orgbbb9a33}
Ground truth for the \emph{Fabas} image.}
\end{figure}

\begin{table}[htbp]
\caption{\label{tab:org1b887c4}
...
their standard deviation. \emph{You can check the figure \ref{orgbb190f6} to do it automatically}.
\end{enumerate}
...
\end{work}
\section{Appendix}
\label{sec:orgf250d70}
\subsection{Short introduction to shell}
\label{sec:org574d384}
